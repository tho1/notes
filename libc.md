Understanding the lib c is important as it is tightly integrated with kernel under it. And the C libary with the corresponding C compiler determines the functionalities of the operating system.
